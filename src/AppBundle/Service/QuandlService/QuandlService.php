...
namespace AppBundle\Service\QuandlService;


//--------------------------------------------------------------
// Class: QuandlService API
//--------------------------------------------------------------
class QuandlService
{
    public $api_key;
    ...
    // get provides access to any QuandlService API endpoint. There is no need
    ...
    // getDatabases returns the list of databases. QuandlService limits it to
    ...
    // --- Private Methods
    // getFormat returns one of the three formats supported by QuandlService.
    // It is here for two reasons:
    //  1) we also allow "object" format. this will be sent to QuandlService
    //     as "json" but the getData method will return a json_decoded
    //     output.
    //  2) some QuandlService nodes do not support CSV (namely search).
    ...
    // either from cache (if cache_handler is set) or from QuandlService.
    ...
    //     language syntax to QuandlService format
    ...
    // PHP (e.g. "today-30 days") to the format needed by QuandlService
